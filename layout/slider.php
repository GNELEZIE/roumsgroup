    ...
    <div class="tp-banner" >
        <ul>
            <li data-slotamount="7" data-transition="incude" data-masterspeed="1000" data-saveperformance="on">
                <img alt="" src="<?=$cdn_domaine?>/media/dummy.png" data-lazyload="<?=$cdn_domaine?>/media/m01.png">
                ...
                <div class="caption lfb large-title tp-resizeme slidertext2" data-x="left" data-y="310" data-speed="600" data-start="2800">
                    Nous construisons vos maisons de rêve
                </div>
                <div class="caption lfl large-title tp-resizeme slidertext3" data-x="left" data-y="350" data-speed="600" data-start="3500">
                    <a href="<?=$domaine?>/contact">Contactez-nous</a></div>
            </li>
            <li data-slotamount="7" data-transition="3dcurtain-vertical" data-masterspeed="1000" data-saveperformance="on">
                ...
                <div class="caption lfb large-title tp-resizeme slidertext4 slidertext6" data-x="center" data-y="310" data-speed="600" data-start="2800">
                    Nous proposons la réalisation de tous types de bâtiment métallique, <br>charpentes métalliques en kit.</div>
                <div class="caption lfl large-title tp-resizeme slidertext3 slidertext7" data-x="center" data-y="350" data-speed="600" data-start="3500">
